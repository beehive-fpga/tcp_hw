...
(
    ...
    ,input  logic                                   save_commit_idx // TODO: add save_commit_real_ptr here
    ...
    ,output logic   [RX_PAYLOAD_IDX_W-1:0]          datapath_wr_buf_req_wr_idx
    ...
    assign datapath_wr_buf_req_wr_idx = commit_idx_reg.idx[RX_PAYLOAD_IDX_W-1:0];
